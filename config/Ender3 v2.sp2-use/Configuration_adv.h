...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define EVENT_GCODE_SD_ABORT "G1 X0 Y200\nM18"      // SP G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
 ...
 */
  ...
  #define PROBE_PT_1 {  30,  30 }   // SP (mm) { x, y }
  #define PROBE_PT_2 {  30, 200 }   // SP 
  #define PROBE_PT_3 { 200, 115 }   // SP 
#endif
 ...
 */
  ...
  #define MESH_MAX_X X_BED_SIZE - 30  // SP
