 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, -5, 0 }  // SP: own BL mounting (Z= -2,53mm)
...
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 4)  // SP
 ...
 */
#define MULTIPLE_PROBING 2  // SP
#define EXTRA_PROBING    1  // SP
 ...
 */
#define RESTORE_LEVELING_AFTER_G28  // SP
//#define ENABLE_LEVELING_AFTER_G28

/**
 * Auto-leveling needs preheating
 */
//#define PREHEAT_BEFORE_LEVELING  // SP
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 15             // SP Set Mesh bounds as an inset region of the bed
  #define GRID_MAX_POINTS_X 7       // SP Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y 6       // SP
...
#define LCD_BED_TRAMMING  // ProUI has a bed tramming menu
  ...
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 30, 30 } // SP (mm) Left, Front, Right, Back insets 
   ...
   */
  #define BED_TRAMMING_LEVELING_ORDER { LF, LB } // SP
#endif
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  //#define EEPROM_INIT_NOW   // Init EEPROM on first boot after a new build.  // SP
#endif
...
#define NOZZLE_PARK_FEATURE  // MRiscoC Enabled
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 25), (Y_MAX_POS - 10), 20 }  // SP
